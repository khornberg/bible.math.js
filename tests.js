...
test("distance same book", function() {
    ...
    var ref2 = {bookIndex: 0, chapter: 0, verse: 3, chapter1: 0, verse1: 3, chapter2: -1, verse2: -1};
    var resultDistance = bible.distance(ref1, ref2);
...
test("distance same book single ref", function() {
    var ref1 = {bookIndex: 0, chapter: 0, verse: 1, chapter1: 0, verse1: 1, chapter2: 0, verse2: 3};
...
test("distance ref equals add of verses ref", function() {
    ...
    var addexpectedResults = {bookIndex: 2, chapter: 1, verse: 5, chapter1: 3, verse1: 6, chapter2: -1, verse2: -1}
...
test("distance ref equals subtract of verses ref", function() {
    ...
    var addexpectedResults = {bookIndex: 0, chapter: 3, verse: 5, chapter1: 1, verse1: 6, chapter2: -1, verse2: -1}
	deepEqual(addresult, addexpectedResults);
});
